...
public class Taller6 {
     ...
     * ejemplo, para las entradas 1 , 2 , 6, -1
	...
	try (Scanner in = new Scanner(System.in)) {
		...
		int n = in.nextInt();
		while (n != -1 ) {
			System.out.print("Ingrese un número, recuerde escirbir -1 para parar: ");
		    arry.add(n);
		    n = in.nextInt();
		}
	}
    ...
    /**
     * @param n el número hasta el cual se llevara acabo el patrón siguiente.
     * vamos a implementar un nuevo a la vez, no antes de haber
